...
CREATE TABLE IF NOT EXISTS `kt_admin_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='管理员账户表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `kt_admin_user`
--

INSERT INTO `kt_admin_user` (`id`, `username`, `password`, `salt`, `status`, `auth_key`, `create_time`, `update_time`, `order_id`) VALUES
(1, 'admin', 'cf26e7290b899c95fad2aa41d194f1f6', 'D2OJR', 1, '123', 0, 0, 1);
...
CREATE TABLE IF NOT EXISTS `kt_city` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='城市表' AUTO_INCREMENT=346 ;

--
-- 转存表中的数据 `kt_city`
--

INSERT INTO `kt_city` (`id`, `name`, `zipcode`, `province_id`) VALUES
(1, '北京市', '100000', 1),
(2, '天津市', '100000', 2),
(3, '石家庄市', '050000', 3),
(4, '唐山市', '063000', 3),
...
CREATE TABLE IF NOT EXISTS `kt_district` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='区县表' AUTO_INCREMENT=2863 ;

--
-- 转存表中的数据 `kt_district`
--

INSERT INTO `kt_district` (`id`, `name`, `city_id`) VALUES
(1, '东城区', 1),
(2, '西城区', 1),
(3, '崇文区', 1),
(4, '宣武区', 1),
...
CREATE TABLE IF NOT EXISTS `kt_material` (
  ...
  PRIMARY KEY (`id`),
  KEY `type` (`type`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='附件表' AUTO_INCREMENT=7 ;

--
-- 转存表中的数据 `kt_material`
--

INSERT INTO `kt_material` (`id`, `name`, `host`, `filepath`, `filename`, `type`, `imgwidth`, `imgheight`, `filesize`, `create_time`) VALUES
(1, 'CAXD{UJ})LKW9[8V1XS2]NL.gif', 'http://localhost/kitty-o2o/data/upload/', 'system/2016/04/', '1a637d455f5b826df574a8f282e245a5.gif', 'image', 300, 330, 2082361, 1460775353),
(2, '2.jpg', 'http://localhost/kitty-o2o/data/upload/', 'system/2016/04/', '5806ac7456abcc1a4fbc90a05ccd6385.jpg', 'image', 782, 1024, 172624, 1460816853),
(3, '2.jpg', 'http://localhost/kitty-o2o/data/upload/', 'system/2016/04/', '3d85699b64e385619f9a61fe641909bc.jpg', 'image', 782, 1024, 172624, 1461069171),
(4, 'CAXD{UJ})LKW9[8V1XS2]NL.gif', 'http://localhost/kitty-o2o/data/upload/', 'system/2016/04/', 'f11462541dea3dc1e9f40809377e2e4f.gif', 'image', 300, 330, 2082361, 1461483504),
(5, '2.jpg', 'http://localhost/kitty-o2o/data/upload/', 'system/2016/04/', 'ccf3cfe9eeb15b910313a9bc9daf9cc6.jpg', 'image', 782, 1024, 172624, 1461484332),
(6, 'CAXD{UJ})LKW9[8V1XS2]NL.gif', 'http://localhost/kitty-o2o/data/upload/', 'system/2016/04/', '524c88d7c798b7483c0cb49d813c5c7a.gif', 'image', 300, 330, 2082361, 1461485836);
...
CREATE TABLE IF NOT EXISTS `kt_membership` (
  `store_id` int(11) NOT NULL DEFAULT '0',
  `member_id` int(11) NOT NULL DEFAULT '0',
  `create_time` int(11) NOT NULL DEFAULT '0',
  UNIQUE KEY `store_id` (`store_id`,`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员与商家的关联表';
...
CREATE TABLE IF NOT EXISTS `kt_province` (
  ...
  `name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='省份表' AUTO_INCREMENT=35 ;

--
-- 转存表中的数据 `kt_province`
--

INSERT INTO `kt_province` (`id`, `name`) VALUES
(1, '北京市'),
(2, '天津市'),
(3, '河北省'),
(4, '山西省'),
...
CREATE TABLE IF NOT EXISTS `kt_store` (
  ...
  `geohash` varchar(50) DEFAULT NULL COMMENT 'geohash',
  ...
  PRIMARY KEY (`id`),
  KEY `geohash` (`geohash`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商家表' AUTO_INCREMENT=10 ;

--
-- 转存表中的数据 `kt_store`
--

INSERT INTO `kt_store` (`id`, `name`, `linkman`, `phone`, `address`, `open_stime`, `open_etime`, `province_id`, `city_id`, `district_id`, `longitude`, `latitude`, `geohash`, `brief`, `logo_id`, `status`, `poi_id`, `create_time`, `update_time`, `order_id`) VALUES
(8, '烧饼店', '周润发', '15996328741', '江苏省南京市江宁区', '00:00:00', '00:00:00', 4, 16, 231, '119.04766100', '32.01968100', 'wtswhvpb5t1vj58', '烧饼店', 3, 2, 1671716114, 1461069171, 1461483040, 8),
(9, '呼啦啦', '周星星', '15996328740', '江苏省南京市鼓楼区四卫头54巷-9号', '00:00:00', '00:00:00', 7, 55, 561, '118.77651700', '32.07317900', 'wtsqqydrv3ym', '牛逼', 6, 2, 1675811874, 1461485836, 1461486765, 9);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='商家账户表' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `kt_store_account`
--

INSERT INTO `kt_store_account` (`id`, `store_id`, `account_name`, `password`, `salt`, `status`, `create_time`, `update_time`, `order_id`) VALUES
(2, 7, 'kitty7', 'e5ed0a98ce58af6293247ebf57e0af34', 've221', 1, 1460993116, 1460993116, 2);
