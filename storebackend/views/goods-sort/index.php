...
$this->params = ['breadcrumb'  => [['name' => '商品分类','url' => '#','current' => 1]]];
?>
<div class="row-fluid">
<div class="span12">
	<div class="widget-box">
		<div class="widget-title">
			...
			<h5>商品分类列表</h5>
			<a class="btn btn-info label" href="<?= Url::to(['goods-sort/form']);?>">创建</a>
		</div>
		<div class="widget-content">
				...
				<tbody>
				   ...
				   <?php foreach ($models AS $k => $v): ?>
					<tr id="tr_<?= $v['id'] ?>">
						...
						<td><?= $v['name'] ?></td>
						<td>
						   <a href="<?= Url::to(['goods-sort/form','id' => $v['id']]);?>" class="btn btn-primary"><i class="icon-pencil icon-white"></i>编辑分类</a>
					...
					<tr>
					   <td colspan="6">
   					   <div class="alert alert-info" style="margin-top:22px;">
   							...
   							<strong>友情提醒！</strong> 该商家目前还没有商品分类
   						</div>
					   </td>
			      </tr>
					<?php endif; ?>
			...
			<input type="hidden" class="delete-action" value="<?= Url::to(['goods-sort/delete']);?>" />
